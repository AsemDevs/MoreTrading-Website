    ...
    <div class="py-3 flex justify-between items-center">
        ...
        <div class="flex items-center">
            ...
            <div class="flex items-center space-x-3 loginreg">
                <a href="#" class="font-medium text-white text-sm md:text-m rounded bg-primary hover:bg-gray-700 px-3 md:px-7 py-0 md:py-2">Log in</a> <!-- Adjusted padding and font size -->
                <a href="#" class="font-medium text-white text-sm md:text-m bg-primary rounded hover:bg-gray-700 px-3 md:px-7 py-0 md:py-2">Sign Up</a> <!-- Adjusted padding and font size -->
            </div>
        </div>
