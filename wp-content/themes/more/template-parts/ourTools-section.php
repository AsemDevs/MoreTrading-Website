<div class="our-tools lg:container py-6 px-4 sm:px-6 md:py-14 sm:mx-auto md:mb-24">
    ...
    <p class="text-xs sm:text-sm text-tertiary my-9 text-left sm:text-center font-semibold">Access news & economic calendar, technical indicators & charts, Forex Calculators,<br> educational resources and many more tools to help you excel.</p>
