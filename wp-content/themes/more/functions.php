...
class Tailwind_Walker_Nav_Menu extends Walker_Nav_Menu
{
    ...
    function start_lvl(&$output, $depth = 0, $args = array())
    {
        ...
        $output .= "\n$indent<ul class=\"submenu lg:absolute lg:hidden lg:group-hover:block sm:text-sm lg:mt-0 lg:w-64 lg:rounded-md lg:shadow-lg sm:bg-white lg:ring-1 lg:ring-black lg:ring-opacity-5 focus:outline-none\">\n";
    }
